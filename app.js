    ...
    function Game() {
        ...
        this.displayRuns = function () {
            ...
            if (_this.players <= 10) {
                ...
                if (_this.balls <= 6) {
                    ...
                    if (run === 0) {
                        if (count == 1) {
                            playersArr1.push(_this.total);
                            console.log(playersArr1);
                        }
                        if (count == 2) {
                            playersArr2.push(_this.total);
                            console.log(playersArr1);
                        }
                        document
        ...
        this.handleWinner = function () {
            ...
            if (team1 > team2) {
                ...
                hitResult.addEventListener("click", function () {
