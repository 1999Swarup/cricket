...
img.setAttribute('src', "love-cricket.gif");
img.setAttribute('style', "height:200px;width:280px;clip: rect(0px,200px,50px,0px);");
...
boardcontainer.setAttribute("id", "resultBoard");
boardcontainer.setAttribute("class", "text-center mt-5");
document.body.appendChild(boardcontainer);

var button1 = document.createElement("button");
button1.setAttribute("class", "btn btn-primary");
button1.setAttribute("id", "GENERATE RESULT");
// button1.setAttribute("onclick", game.displayRuns);
button1.innerHTML = "GENERATE RESULT";
document.getElementById("resultBoard").appendChild(button1);

//result
var mainResult = document.createElement("p");
mainResult.setAttribute("id", "mainresult");
document.getElementById("resultBoard").appendChild(mainResult);
...
//column entities
thead1.innerHTML +=
    `<tr id="t11"><th>Player 1</th></tr>
    <tr id="t12"><th>Player 2</th></tr>
    <tr  id="t13"><th>Player 3</th></tr>
    <tr  id="t14"><th>Player 4</th></tr>
    <tr  id="t15"><th>Player 5</th></tr>
    <tr id="t16"><th>Player 6</th></tr>
    <tr  id="t17"><th>Player 7</th></tr>
    <tr  id="t18"><th>Player 8</th></tr>
    <tr  id="t19"><th>Player 9</th></tr>
    <tr id="t110"><th>Player 10</th></tr>`;
...
//column entities
thead2.innerHTML +=
    '<tr  id="t21"><th>Player 1</th></tr><tr id="t22"><th >Player 2</th></tr><tr  id="t23"><th>Player 3</th></tr><tr id="t24"><th  >Player 4</th></tr><tr  id="t25"><th >Player 5</th></tr><tr  id="t26"><th>Player 6</th></tr><tr  id="t27"><th>Player 7</th></tr><tr  id="t28"><th >Player 8</th></tr><tr id="t29"><th >Player 9</th></tr><tr  id="t210"><th >Player 10</th></tr>';
...
var hitResult = document.getElementById("GENERATE RESULT");
...
class Game {
  ...
  displayRuns = () => {
    ...
    if (this.players <= 10) {
      ...
      if (this.balls <= 6) {
        ...
        if (run === 0) {
          if(count==1){playersArr1.push(this.total);console.log(playersArr1)}
        if(count==2){playersArr2.push(this.total);console.log(playersArr1)}
          document
     ...
     if(f==1){
      max1 = Math.max(...playersArr1);
      maxi1 = playersArr1.indexOf(max1)+1;
      console.log(max1,maxi1,playersArr1.length);
     }
     if(f==2){
      max2 = Math.max(...playersArr2);
      maxi2 = playersArr2.indexOf(max2);
      console.log(max2,maxi2,playersArr2.length);
     }
  ...
  handleWinner = () => {
    ...
    if (team1 > team2) {
      ...
      hitResult.setAttribute("class", "btn btn-success");
      hitResult.addEventListener("click", ()=>{
          
        document.getElementById("mainresult").innerHTML = `<h2>MAN OF THE MATCH</h2>Player ${maxi1}<p>TEAM 1</p><h2>SCORE</h2>${max1}`;
      });
    } else if (team1 < team2) {
     ...
     hitResult.setAttribute("class", "btn btn-success");
      hitResult.addEventListener("click", ()=>{
        ...
        document.getElementById("mainresult").innerHTML = `<h2>MAN OF THE MATCH</h2>Player ${maxi2}<p>TEAM 2</p><h2>SCORE</h2>${max2}`;
      });
    } else {
      document.getElementById("result").innerHTML = "Match Tied";
      hitResult.setAttribute("class", "btn btn-success");
      hitResult.addEventListener("click", ()=>{
        document.getElementById("mainresult").innerHTML = `<h2>MATCH TIE</h2>`;
      });
    }
  };
}
